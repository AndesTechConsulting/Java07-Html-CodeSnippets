...
function getFormData2(fm){
    
    var form_array =fm.serializeArray();
    var arr = {};
...
//    console.log(evt.target.id);
    var arr2 = getFormData('#' + evt.target.id);
    var login = arr2["login"]; 
    console.log(JSON.stringify(arr2));
 
    if(localStorage[login]){
        alert("User with login " + login + " already exists...! User has not been added!" );
...
{
    var login = $.cookie("loginOk");  if(!login) {alert("Вы ещё не вошли в систему."); return ;}
